	...
	<div class="single">
		<div class="container">
				...
				<div class="flexslider">
					<ul class="slides">
						...
						<li data-thumb="images/c.jpg">
						   <div class="thumb-image"> <img src="images/phones/10.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li> 
					</ul>
				</div>
				<!-- flexslider -->
			...
			<div class="col-md-8 single-right">
				<h3>Smartphone OPPO A12 - Bleu</h3>
				<div class="rating1">
				...
				<div class="description">
					...
					<p>Ecran 5.22" LCD IPS (700x 1630Pixels) - Ecran  Gorilla Glass 3 - Processeur: M765 quad-Core ( Cortex-A53 4x2,40 GHz et Cortex-A53 4x1,8 GHz) - Systéme d'exploitation: Android 8.0  </p>
				</div>
