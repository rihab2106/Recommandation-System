		...
		<div class="container">
				...
				<div class="flexslider">
					<ul class="slides">
						...
						<li data-thumb="images/c.jpg">
						   <div class="thumb-image"> <img src="images/phones/2.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li> 
					</ul>
				</div>
				<!-- flexslider -->
			...
			<div class="col-md-8 single-right">
				...
				<div class="description">
					...
					<p>Écran 5.0" - Processeur: Quad Core 1.3 GHz - Systéme d'exploitation: Android 8.1 - Mémoire RAM: 1 Go - Stockage: 8 Go - Appareil Photo Arriére: 5.0 MégaPixels - Appareil Photo Avant: 2.0 MégaPixels - .</p>
				</div>
