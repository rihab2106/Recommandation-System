	...
	<div class="single">
		<div class="container">
				...
				<div class="flexslider">
					<ul class="slides">
						...
						<li data-thumb="images/c.jpg">
						   <div class="thumb-image"> <img src="images/phones/3.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li> 
					</ul>
				</div>
				<!-- flexslider -->
			...
			<div class="col-md-8 single-right">
				<h3>Smartphone IPRO L50 3G+ - Gold</h3>
				<div class="rating1">
				...
				<div class="description">
					...
					<p>Taille d'écran 5.0" - Processeur: Quad-Core - Systéme d'exploitation: Android 6.0 - Mémoire RAM: 1 Go - Stockage: 8 Go Extensible Jusqu'à 32 Go - Appareil Photo Arriére: 8.0 MégaPixels Led Flash light .</p>
				</div>
