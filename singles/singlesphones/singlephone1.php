	...
	<div class="single">
		<div class="container">
				...
				<div class="flexslider">
					<ul class="slides">
						...
						<li data-thumb="images/c.jpg">
						   <div class="thumb-image"> <img src="images/phones/1.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li> 
					</ul>
				</div>
				<!-- flexslider -->
			...
			<div class="col-md-8 single-right">
				<h3>Smartphone LENOVO B A2016 4G Gold</h3>
				<div class="rating1">
				...
				<div class="description">
					...
					<p>Smartphone Lenovo B A2016 - Taille d'écran 4.5 Pouces WVGA TFT - Résolution d'écran: 854 x 480 pixels - Processeur Quad-Core 1.3GHz -  Systéme d'exploitation: Android 5.0 Lollipop - Mémoire RAM: 1 Go  .</p>
				</div>
