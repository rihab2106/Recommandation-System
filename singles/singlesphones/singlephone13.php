	...
	<div class="single">
		<div class="container">
				...
				<div class="flexslider">
					<ul class="slides">
						...
						<li data-thumb="images/c.jpg">
						   <div class="thumb-image"> <img src="images/phones/13.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li> 
					</ul>
				</div>
				<!-- flexslider -->
			...
			<div class="col-md-8 single-right">
				<h3>Smartphone ALCATEL 3X 2019 - Noir (ALCATEL-3X-BLACK)</h3>
				<div class="rating1">
				...
				<div class="description">
					...
					<p>Ecran: 6.52" IPS LCD - Résolution: 720 x 1600 pixels - Processeur: Mediatek MT6763V Helio P23 Octa core (4x2.0 GHz Cortex-A53 & 4x1.5 GHz Cortex-A53) - Système d'exploitation: Android 9.0 Pie - Mémoire  </p>
				</div>
