	...
	<div class="single">
		<div class="container">
				...
				<div class="flexslider">
					<ul class="slides">
						...
						<li data-thumb="images/c.jpg">
						   <div class="thumb-image"> <img src="images/phones/4.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li> 
					</ul>
				</div>
				<!-- flexslider -->
			...
			<div class="col-md-8 single-right">
				<h3>Smartphone IKU Y3 - Gold (IKU-Y3-GOLD)</h3>
				<div class="rating1">
				...
				<div class="description">
					...
					<p>Ecran: 5.5" HD - Processeur: Quad core - Système d'exploitation: Android - Mémoire RAM: 1 Go - Stockage: 16 Go - Appareil Photo Arriére: 5 MP + 2 MP - Appareil Photo Frontale: 5 MP - Capacité de Batte .</p>
				</div>
