	...
	<div class="single">
		<div class="container">
				...
				<div class="flexslider">
					<ul class="slides">
						...
						<li data-thumb="images/c.jpg">
						   <div class="thumb-image"> <img src="images/phones/14.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li> 
					</ul>
				</div>
				<!-- flexslider -->
			...
			<div class="col-md-8 single-right">
				<h3>Smartphone ALCATEL 3X 2019 - Vert (ALCATEL-3X-GREEN)</h3>
				<div class="rating1">
				...
				<div class="description">
					...
					<p>Ecran: 5.2"  Résolution: 840 x 1780 pixels - Processeur: M763V Hio P23 quad core (4x2.0 GHz Cortex-A53 & 4x1.5 GHz Cortex-A53) - Système : Android 8.0 Pie - Mémoire </p>
				</div>
