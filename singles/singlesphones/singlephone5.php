	...
	<div class="single">
		<div class="container">
				...
				<div class="flexslider">
					<ul class="slides">
						...
						<li data-thumb="images/c.jpg">
						   <div class="thumb-image"> <img src="images/phones/5.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li> 
					</ul>
				</div>
				<!-- flexslider -->
			...
			<div class="col-md-8 single-right">
				<h3>Smartphone EVERTEK M10 3G Bleu</h3>
				<div class="rating1">
				...
				<div class="description">
					...
					<p>Ecran: 5.45" TN FWVGA+ (480 x 960 pixels ) - Processeur: SC7731E Quad core 1.3GHz - Système d'exploitation: Android Go - Mémoire RAM: 1Go - Stockage: 16 Go - Appareil Photo Arriére 5.0 MP , Appareil P.</p>
				</div>
