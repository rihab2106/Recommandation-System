	...
	<div class="single">
		<div class="container">
				...
				<div class="flexslider">
					<ul class="slides">
						...
						<li data-thumb="images/c.jpg">
						   <div class="thumb-image"> <img src="images/phones/7.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li> 
					</ul>
				</div>
				<!-- flexslider -->
			...
			<div class="col-md-8 single-right">
				<h3>Smartphone NOKIA 2.3 Vert</h3>
				<div class="rating1">
				...
				<div class="description">
					...
					<p>Ecran 6,2” HD+ (720 x 1520 pixels) avec encoche à selfies - Processeur: MediaTek Helio A22 Quad-Core 2.0 GHz - Systéme d'exploitation: Android 9.0 Pie upgrade to Android 10.0; Android One - Mémoire RA.</p>
				</div>
