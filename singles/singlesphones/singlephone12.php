	...
	<div class="single">
		<div class="container">
				...
				<div class="flexslider">
					<ul class="slides">
						...
						<li data-thumb="images/c.jpg">
						   <div class="thumb-image"> <img src="images/phones/12.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li> 
					</ul>
				</div>
				<!-- flexslider -->
			...
			<div class="col-md-8 single-right">
				<h3>Smartphone SAMSUNG Galaxy A10s Rouge (SM-A107F-RED</h3>
				<div class="rating1">
				...
				<div class="description">
					...
					<p>Ecran Infinity-V 6.2" HD+ Tactile - Résolution: (720 x 1520) - Systéme d'exploitation:  Android 9.0 - Processeur: Octa core (2.0 + 1.5 GHz) - Mémoire RAM: 2 Go - Stockage: 32 Go,  MicroSD jusqu'à 512   </p>
				</div>
