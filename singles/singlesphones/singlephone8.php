	...
	<div class="single">
		<div class="container">
				...
				<div class="flexslider">
					<ul class="slides">
						...
						<li data-thumb="images/c.jpg">
						   <div class="thumb-image"> <img src="images/phones/8.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li> 
					</ul>
				</div>
				<!-- flexslider -->
			...
			<div class="col-md-8 single-right">
				<h3>Smartphone NOKIA 2.3 Gris</h3>
				<div class="rating1">
				...
				<div class="description">
					...
					<p>Ecran 5,2”  (830x 1650pixels) - Processeur: Helio A22 Octa-Core 2.0 GHz - Systéme d'exploitation: Android 9.0 Pie upgrade to Android 10.0; Android One - Mémoire RAM :8 GB.</p>
				</div>
