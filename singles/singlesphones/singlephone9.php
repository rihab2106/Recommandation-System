	...
	<div class="single">
		<div class="container">
				...
				<div class="flexslider">
					<ul class="slides">
						...
						<li data-thumb="images/c.jpg">
						   <div class="thumb-image"> <img src="images/phones/9.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li> 
					</ul>
				</div>
				<!-- flexslider -->
			...
			<div class="col-md-8 single-right">
				<h3>Smartphone OPPO A12 - Noir</h3>
				<div class="rating1">
				...
				<div class="description">
					...
					<p>Ecran 6.22" LCD IPS (750 x 1520 Pixels) - Ecran Corning Gorilla Glass 3 - Processeur: Mediatek MT6765 Octa-Core ( Cortex-A53 4x2,35 GHz et Cortex-A53 4x1,8 GHz) - Systéme d'exploitation: Android 9.0 (</p>
				</div>
