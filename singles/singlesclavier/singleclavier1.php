...
<body> 
				...
				<div class="flexslider">
					<ul class="slides">
						...
						<li data-thumb="images/c.jpg">
						   <div class="thumb-image"> <img src="images/claviers/1.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li> 
					</ul>
				</div>
				<!-- flexslider -->
	...
	<div class="w3ls_mobiles_grid_right_grid2_right">
				 ...
				 <div class="description">
					...
					<p>Clavier Gamer Mécanique REDRAGON Kumara - Connectivité: Filaire - Interface: USB - Clavier mécanique QWERTY - commutateurs personnalisés (équivalent Cherry MX Blue) - 87 touches mécaniques - 12 touche .</p>
				</div>
	...
	<div class="w3l_related_products">
		<div class="container">
			<h3>Produits des utilisateurs similaires</h3>
			<ul id="flexiselDemo2">

			<!--bloc php -->	
			<?php 
			$filename = 'C:\wamp\www\web\images\claviers\matriceSimUser.txt';
			$simmat = []; 
			if (($h = fopen("{$filename}", "r")) !== FALSE) 
             ...
             $filename = 'C:\wamp\www\web\images\claviers\matricenotes.txt';
			$notemat = []; 
			if (($h = fopen("{$filename}", "r")) !== FALSE) 
             {
             ...
             (new Pc('modele 1','1500','images/claviers/1.jpg','singleclavier1'),new Pc('modele 2','1500','images/claviers/2.jpg','singleclavier2'),new Pc('modele 3','1500','images/claviers/3.jpg','singleclavier3'),new Pc('modele 4','1500','images/claviers/4.jpg','singleclavier4'),new Pc('modele 5','1500','images/claviers/5.jpg','singleclavier5'),new Pc('modele 6','1500','images/claviers/6.jpg','singleclavier6'),new Pc('modele 7','1500','images/claviers/7.jpg','singleclavier7'),new Pc('modele 8','1500','images/claviers/8.jpg','singleclavier8'),new Pc('modele 9','1500','images/claviers/9.jpg','singleclavier9'),new Pc('modele 10','1500','images/claviers/10.jpg','singleclavier10'),new Pc('modele 11','1500','images/claviers/11.jpg','singleclavier11'),new Pc('modele 12','1500','images/claviers/12.jpg','singleclavier12'),new Pc('modele 13','1500','images/claviers/13.jpg','singleclavier13'));
                 ...
                 switch ($_SESSION["users"]) 
                 {
                        ...
                        $sim=array_column($simmat, $i);
                        $similaires="";


                           for ($j=0;$j<=3;$j++)
                           {
                           if ($sim[$j] >= 0.30 && $sim[$j] < 1) 
                           	{
                              $similaires=$similaires.strval($j);
                           	}
                         
                           }

                             for ($k=0; $k <13 ; $k++) 
                           { $prod=array_column($notemat, $k);
                           	 $N=0;$eq=0;
                           	   for ($x=0; $x <=3 ; $x++) 
                           	   { 
                           	       	 if (($prod[$x]!=0.00) && (strpos($similaires, strval($x))!==false))
                           	       	 {
                           	       	 	$N++;
                           	       	 	$eq=$eq+$prod[$x];
					               ...
					               {   
						               echo ' <html> <li>
					                          <div class="w3l_related_products_grid">
						                       <div class="">
						                      	<div class="">
							                  	<img src="'.$pcsarray[$k]->lien.'" alt="mafamesh" class="img-responsive" />
						                     	...
						                     	<h5><a href="'.$pcsarray[$k]->singledir.'.php">nous avons prédit que vous aimeriez ce produit '.$pcsarray[$k]->modele.'  avec un note prévue de: '.$res.'</a></h5>
							                        <div class="simpleCart_shelfItem"> 
							              	<p class="flexisel_ecommerce_cart"><i class="item_price">'.$pcsarray[$k]->prix.'</i></p> 
							                 </div>
						                       </div>
					                         </div>
				                            </li></html>';
