...
<body> 
				...
				<div class="flexslider">
					<ul class="slides">
						...
						<li data-thumb="images/c.jpg">
						   <div class="thumb-image"> <img src="images/claviers/12.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li> 
					</ul>
				</div>
				<!-- flexslider -->
	...
	<div class="w3ls_mobiles_grid_right_grid2_right">
				...
				<div class="description">
					...
					<p>Clavier mécanique Gaming CORSAIR Strafe Cherry MX Rétro-éclairé - Type de toucher: Switch Cherry MX Red - 104 Touches personnalisables (Entièrement programmable ) - Norme du clavier: AZERTY - Technologie .</p>
				</div>
