...
<body> 
				...
				<div class="flexslider">
					<ul class="slides">
						...
						<li data-thumb="images/c.jpg">
						   <div class="thumb-image"> <img src="images/claviers/6.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li> 
					</ul>
				</div>
				<!-- flexslider -->
	...
	<div class="w3ls_mobiles_grid_right_grid2_right">
				...
				<div class="description">
					...
					<p>Clavier mécanique AZERTY Standard de 150 Touche -  Rétro-éclairage de l'intérieur des touches  avec 7 couleurs ,10 effets de lumiére - Verrouillage touche Windows et Application - compatible avec wind  .</p>
				</div>
