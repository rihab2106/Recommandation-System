...
<body> 
				...
				<div class="flexslider">
					<ul class="slides">
						...
						<li data-thumb="images/c.jpg">
						   <div class="thumb-image"> <img src="images/claviers/13.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li> 
					</ul>
				</div>
				<!-- flexslider -->
	...
	<div class="w3ls_mobiles_grid_right_grid2_right">
				...
				<div class="description">
					...
					<p>Clavier Gamer REDRAGON K580 VATA - Connectivité: Filaire - Clavier mécanique AZERTY de 104 touches - 5 touches de macro programmables - 12 touches multimédias - 18 modèles de rétroéclairage - Fonction .</p>
				</div>
