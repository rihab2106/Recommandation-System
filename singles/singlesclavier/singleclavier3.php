...
<body> 
				...
				<div class="flexslider">
					<ul class="slides">
						...
						<li data-thumb="images/c.jpg">
						   <div class="thumb-image"> <img src="images/claviers/3.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li> 
					</ul>
				</div>
				<!-- flexslider -->
	...
	<div class="w3ls_mobiles_grid_right_grid2_right">
				...
				<div class="description">
					...
					<p>Clavier Mécanique SPIRIT OF GAMER XPERT K700 - Technologie de Connectivité: Filaire - Interface avec l'ordinateur: USB - Norme du clavier: AZERTY - Rétro-éclairage: LED - Clavier Gamer avec touches mé .</p>
				</div>
