...
<body> 
				...
				<div class="flexslider">
					<ul class="slides">
						...
						<li data-thumb="images/c.jpg">
						   <div class="thumb-image"> <img src="images/claviers/9.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li> 
					</ul>
				</div>
				<!-- flexslider -->
	...
	<div class="w3ls_mobiles_grid_right_grid2_right">
				...
				<div class="description">
					...
					<p>Clavier Gamer BlackWidow X Chroma - Norme de Clavier: AZERTY - Connectivité: Filaire - Interface avec l'ordinateur: USB - Type de Touches: touches mécaniques à Switch Razer Green - Chassis en métal de .</p>
				</div>
