...
<body> 
				...
				<div class="flexslider">
					<ul class="slides">
						...
						<li data-thumb="images/c.jpg">
						   <div class="thumb-image"> <img src="images/claviers/4.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li> 
					</ul>
				</div>
				<!-- flexslider -->
	...
	<div class="w3ls_mobiles_grid_right_grid2_right">
				...
				<div class="description">
					...
					<p>Clavier ASUS TUF Gaming K5 - Rétro-éclairé (Cinq zones d'éclairage ASUS Aura Sync RGB - Technologie de Connectivité: Filaire - Interface de Connetivité: USB - Norme de Clavier: AZERTY - Interrupteurs  .</p>
				</div>
